        ...
        <div class="card">
          <form class="card-body p-4" method="post" action="./reg.php">
            ...
            <div class="row">
              ...
              <div class="col-lg-7">
                <h5 class="mb-3"><a href="./sanpham.php" class="text-body"><i
                  ...
                  <div class="d-flex flex-row align-items-center">
                    <div class="d-flex flex-row align-items-center">
                      ...
                      <div class="d-flex flex-row align-items-center">
                          ...
                          <a href="./components/deleteproduct-cart.php?id=<?php echo $product_id;?>" style="color: #cecece;"><i class="ti-trash"></i></a>
                      </div>
                    </div>
                </div>
            </div>
                  ...
                  <div class="card bg-primary text-white rounded-3">
                    <div class="card-body">
                      ...
                      <div class="d-flex justify-content-between mb-4">
                        ...
                        <p class="mb-2"><?php if (isset($_SESSION['cart']) && count($_SESSION['cart']) > 0) {
                          echo "$totalprice "."đ" ;
                        }else{
                          echo "0đ";
                        } ?></p>
