        ...
        <div class="container">
            <?php 
                if (!isset($_SESSION['user'])) { ?>
                    <a href="./view/user/login.php"><button type="button" class="btn btn-default">Đăng nhập</button></a>
                    <a href="./view/user/signup.php"> <button type="button" class="btn-login">Đăng KÝ</button></a>
                    <?php }else{ ?>
                     <p>Xin Chào: 
