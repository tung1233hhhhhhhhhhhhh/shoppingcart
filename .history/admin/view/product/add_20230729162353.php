        ...
        <div class="row">
          ...
          <form method="post" action="reg.php">
            ...
            <div class="form-group">
                ...
                <input type="text" name="price" class="form-control w-25" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập số lượng" >
            </div>
            ...
            <div class="form-group">
                ...
                <input type="file" name="img" class="form-control w-25" id="exampleInputEmail1" aria-describedby="emailHelp"  >
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Tên danh mục </label>
                <select class="form-select form-control w-25 " style="border:none;" aria-label="Default select example">
                    ...
                    $stt= 0;
                        while ($row=$sql->fetch()) {
                            $stt++;
                        ?>
                            <option value='<?php echo $stt?>'><?php echo $row['name_category'] ?></option>
