...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
      $params = ['name' => 'Product', 'key' => 'List','path'=>'#'];
      extract($params);
    ...
    <div class="content">
      <div class="container-fluid">
        ...
        <table class="table table-striped  " style="text-align:center">
         ...
         <?php
         $sql = $conn->query("SELECT count(id) as total from product");
         $sql->execute();
        ...
        //  $sql1 = $conn->query("SELECT product.*, category.name_category FROM product INNER JOIN category ON product.category_id = category.id");
         $sql1 = $conn->query("SELECT category.name_category as name FROM product INNER JOIN category ON product.category_id = category.id");
         $sql1->execute();
         $row = $sql->fetch();
         $row1 = $sql1->fetch();
         ...
         $sql2 =$conn->query("SELECT * FROM product LIMIT $start,$limit");
         $sql2->execute();
         ?>
         ...
         <?php
          ...
          ?>
            <tr >
                        ...
                        <td><img style="width:4rem;" src="../uploads/<?php echo $row['img'] ?>" ></td>
