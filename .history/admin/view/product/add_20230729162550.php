        ...
        <div class="row">
          ...
          <form method="post" action="reg.php">
            ...
            <div class="form-group">
                ...
                <input type="text" name="price" class="form-control w-25" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Nhập giá sản phẩm" >
            </div>
            ...
            <div class="form-group">
                ...
                <input type="file" name="img" class="form-control w-25" style="border:none; id="exampleInputEmail1" aria-describedby="emailHelp"  >
            </div>
            <div class="form-group">
