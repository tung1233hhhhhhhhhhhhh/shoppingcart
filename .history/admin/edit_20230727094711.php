...
?>
        ...
        <form method="post" enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?php echo $rs['News_ID'] ?>"/>
            <input type="hidden" name="img_old" value="<?php echo $rs['image'] ?>"/>
            <label>Title</label>
            <input type="text" value="<?php echo $rs['title'] ?>" name="title" required/>
            <br>
            <label>Intro</label>
            <textarea name="intro"><?php echo $rs['intro'] ?></textarea>
            <br>
            <label>Imgae</label>
            <input type="file" name="file"/><img src="images/<?php echo $rs['image'] ?>"/>
            <br>
