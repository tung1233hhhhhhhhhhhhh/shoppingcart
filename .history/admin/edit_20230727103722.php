...
<form method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="img_old" value="<?php echo $rs['img'] ?>"/>
    <label>Name-sanpham</label>
    <input type="text" value="<?php echo $rs['name_sp'] ?>" name="nameSp" />
    <br>
    <label>soluong</label>
    <input name="soluong" value="<?php echo $rs['soluong'] ?>" />
    <br>
    <label>price</label>
    <input name="price" value="<?php echo $rs['price'] ?>" />
    <br>
    <label>Image</label>
