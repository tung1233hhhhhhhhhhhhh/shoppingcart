...
?>
              ...
              <?php
                if (isset($_SESSION['user'])) {
                  $sql1 = $conn->prepare("SELECT * FROM product WHERE id = :id");
                  $sql1->bindParam(':id', $_SESSION['user']['id'], PDO::PARAM_INT);
                  $sql1->execute();
                  $row1 = $sql1->fetch();
                  if ($row1 !==false) {
            ...
            <form class="mt-4">
                <div class="form-outline form-white mb-4">
                    <input type="text" id="typeName" class="form-control form-control-lg" size="17"
                        placeholder="<?php echo isset($fullname) ? $fullname : "Cardholder's Name"; ?>" />
                    <label class="form-label" for="typeName">Cardholder's Name</label>
                </div>

                <div class="form-outline form-white mb-4">
                    <input type="text" id="typeText" class="form-control form-control-lg" size="17"
                        placeholder="<?php echo isset($sdt) ? $sdt : "1234 5678 9012 3457"; ?>"
                ...
                <div class="form-outline form-white mb-4">
                    <input type="text" id="address" class="form-control form-control-lg" size="17"
                        placeholder="<?php echo isset($address) ? $address : "Cardholder's Address"; ?>" />
                    <label class="form-label" for="address">Cardholder's Address</label>
                </div>
            </form>
