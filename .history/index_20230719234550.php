...
<script>
  ...
  virtual: {
    ...
    renderSlide: function (slide, index) {
      ...
      image1.src = './assets/imgs/slideshows_1.jgp'; // Đường dẫn tới hình ảnh thứ nhất
      
      // Tạo phần tử hình ảnh thứ hai
      var image2 = document.createElement('img');
      image2.src = './assets/imgs/slideshows_2.jgp'; // Đường dẫn tới hình ảnh thứ hai
...
for (var i = 0; i < 3; i++) {
  virtualData.push({
    id: i + 1,
    image1: './assets/imgs/slideshows_1' + (i + 1) + '.jpg', // Đường dẫn tới hình ảnh thứ nhất
    image2: 'p./assets/imgs/slideshows_2' + (i + 1) + '.jpg', // Đường dẫn tới hình ảnh thứ hai
